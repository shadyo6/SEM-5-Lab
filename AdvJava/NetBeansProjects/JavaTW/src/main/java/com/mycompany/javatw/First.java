        ...
        while(flag == 1){
            ...
            switch(c){
                case 1: System.out.println("print characters on the console");
                        try{
                            FileInputStream fip = new FileInputStream("C:\\Users\\Administrator\\Documents\\NetBeansProjects\\JavaTW\\src\\main\\java\\Files\\input.txt");
                            int ch = fip.read();
                ...
                case 3: System.out.println("print contents onto other file");
                        try{
                            FileInputStream fip = new FileInputStream("C:\\Users\\Administrator\\Documents\\NetBeansProjects\\JavaTW\\src\\main\\java\\Files\\input.txt");
                            FileOutputStream fop = new FileOutputStream("C:\\Users\\Administrator\\Documents\\NetBeansProjects\\JavaTW\\src\\main\\java\\Files\\output.txt");
